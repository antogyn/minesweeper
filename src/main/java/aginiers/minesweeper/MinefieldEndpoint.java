...
public class MinefieldEndpoint {
  ...
  public static void broadcast(String message) {
    JsonBroadcasterThread jsonBroadcasterThread =
        new JsonBroadcasterThread(MinefieldEndpoint.users, message);
  ...
  /**
   * Creates a JSON string, used for the log {"type": "log", "data": message}
   * 
   * @param message
   * @return
   */
  ...
  /**
   * Creates a JSON string, used for the userlist {"type": "userlist", "data": [userlist]}
   * 
   * @param message
   * @return
   */
